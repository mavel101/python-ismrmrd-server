...
def insert_prot(prot_file, data_file): 
    ...
    dset_user_prm_dbl[0].name = 'dwellTime_us'
    dset_user_prm_dbl[0].value_ = prot_user_prm_dbl.attrs['dwellTime_us']
    dset_user_prm_dbl[1].name = 'traj_delay' # additional trajectory delay [s]
    dset_user_prm_dbl[1].value_ = prot_user_prm_dbl.attrs['traj_delay']
